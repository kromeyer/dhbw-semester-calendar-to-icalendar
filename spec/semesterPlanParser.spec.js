...
var semesterPlanParser;

semesterPlanParser = require('../src/semesterPlanParser.js');

describe('semesterPlanParser', function() {
  var html;
...
';
  it('should return a list of event objects', function() {
    var result;

    result = semesterPlanParser(html);
    return expect(Object.prototype.toString.call(result)).toBe('[object Array]');
  });
  return it('should return a correct event', function() {
    var result;
    ...
    return expect(result.description).toBe('Raum 135B');
  });
});
